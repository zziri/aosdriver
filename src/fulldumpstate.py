...
def fulldumpstate(driver):
    ...
    driver.sleep()
    driver.clickByXml('resource-id', "com.samsung.android.dialer:id/dialpad_tab_button")
    driver.sleep()
    driver.sendKey('*#9900#')
    driver.sleep()
    driver.clickByXml('text', 'Run dumpstate/logcat')
    driver.sleep()
    driver.waitByXml()
    driver.clickByXml('text', 'OK')
    driver.sleep()
    driver.clickByXml('text', 'Copy to sdcard(include CP Ramdump)')
    driver.sleep()
    driver.waitByXml()
    driver.clickByXml('text', 'OK')
